# PSP Homebrew: Simple Audio Synth Example

This project demonstrates how to generate and play simple audio waveforms (sine, square, triangle) on the PSP using the native audio library.

## What This Project Does
- Generates audio in real-time (sine, square, or triangle wave).
- Lets you change the frequency with the analog stick.
- Lets you switch waveform type with the X button.
- Displays the current frequency and waveform on screen.
...
![Audio Example Screenshot](images/Screenshot_20250914_042302.png)

_Above: The running app showing frequency and waveform type in PPSSPP emulator._
...
This README serves as a note for myself and for GitHub, documenting the process and code for generating audio on the PSP using PSPSDK.